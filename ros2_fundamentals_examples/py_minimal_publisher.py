...
"""
    Description: this ROS2 node periodically publishes "Hello World" messages to a topic.
...
class MinimalPyPublisher(Node):
    ...
    def __init__(self):
        ...
        # Create timer with a period of 0.5 secons to trigger publishsing of message
        timer_period = 0.5
    ...
    def timer_callback(self):
        """Callback function executed periodicaly by yhe timer
        """
        # Create a new String message object
        msg = String()

        # Set the messsage data with a counter
        msg.data = f'Hello World: {self.i}'

        # PUblish the message you created above to a topic
        self.publisher_1.publish(msg)

        # Log a message indicating the message has ben published
...
def main(args=None):
    ...
    # Creating an instance of the Minimal PUblisher node
